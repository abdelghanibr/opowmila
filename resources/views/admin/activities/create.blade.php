        ...
        <div class="col-lg-7 col-md-9 col-12">
            ...
            <div class="card-modern shadow-lg border-0 rounded-4 overflow-hidden">
                <div class="card-header bg-gradient-primary text-white text-center py-4">
                    <h3 class="fw-bold mb-0">➕ إضافة نشاط جديد</h3>
                    <p class="small opacity-75 mt-2">أنشئ نشاطًا رياضيًا أو تدريبيًا جديدًا</p>
                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label for="title" class="form-label fw-semibold text-primary">
                                   إسم التخصص <span class="text-danger">*</span>
                                </label>
                                <input type="text"
                                       name="title"
                                       id="title"
                                       ...
                                       placeholder="مثال: كرة القدم، السباحة، اللياقة البدنية"
                                       required
                                       autofocus>
                                @error('title')
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description"
                                          ...
                                          placeholder="وصف مختصر عن النشاط...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-danger small mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 text-center mb-4">
                                <div class="icon-preview-wrapper position-relative d-inline-block">
                                    <img id="iconPreview"
                                         src="{{ old('icon') ? old('icon') : asset('images/default-activity-icon.png') }}"
                                         alt="معاينة الأيقونة"
                                ...
                                <p class="text-muted small mt-3">معاينة الأيقونة الحالية</p>
                            </div>
